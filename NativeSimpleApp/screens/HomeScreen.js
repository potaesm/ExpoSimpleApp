...
class HomeScreen extends Component {
    ...
    state = { picture: null, name: null, id: null, todoList: [], isVisible: false, selectedItem: null, refreshing: false, isConnected: false, message: '', onNoti: false };
    ...
    async componentDidMount() {
        ...
        if (token) {
            ...
            await this.setState({ picture: picture.data.url, name, id });
        ...
        return (
            <SafeAreaView>
                <ScrollView style={{ height: '100%' }} refreshControl={
                    ...
                    <Overlay isVisible={this.state.onNoti} height={deviceHeight / 4}>
                        <View style={{ justifyContent: 'space-around', flex: 1 }}>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-evenly' }}>
                                <Button
                                    ...
                                    title="OK"
                                    raised
                                    onPress={async () => { this.setState({ onNoti: false }); }}
                                />
                            </View>
                        </View>
                    </Overlay>
